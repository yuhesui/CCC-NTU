// Source of truth: Archived/v1/shared/i18n.js
// Kept as a small no-dependency module for Live Server / static hosting.
...
export const i18n = {
  dictionary: {
    en: {
      ...
      home_mission_body:
        "Elemental Genesis is more than a camp; it is a spiritual dialogue spanning millennia. Through an immersive exploration of the Wuxing philosophy (Metal, Wood, Water, Fire, and Earth), we empower participants to reconnect with the warmth and wisdom of Chinese heritage amidst the pulse of modern life.",
      about_history_title: "Our Heritage",
      about_history_body:
        "Since its inception, the Chinese Society at NTU has been a bridge between tradition and modernity. We are a community of youths passionate about Han culture, dedicated to transforming ancient classics into vibrant, living experiences.",
      ...
      // Event details (registration & about pages)
      event_date: '5th June – 7th June 2026',
      event_venue: 'Nanyang Technological University (NTU)',
      event_fee_full: '$95 (accommodation included)',
      event_fee_day: '$15 (accommodation excluded)',
      event_fee_full_amount: '$95',
      event_fee_day_amount: '$15',
      reg_event_title: '11th Chinese Cultural Camp (CCC)',
      reg_date_label: 'Date:',
      reg_venue_label: 'Venue:',
      reg_fee_label: 'Registration Fee:',
      reg_objectives_label: 'Event Objectives:',
      reg_objectives_value: 'Enhance understanding, encourage exploration on Chinese culture from fresh perspectives',
      ...
      faq_q6: 'faq_q6', faq_a6: 'faq_a6',
      faq_q7: 'faq_q7', faq_a7: 'faq_a7',
      faq_q8: 'faq_q8', faq_a8: 'faq_a8',
      faq_q9: 'faq_q9', faq_a9: 'faq_a9',
      faq_q10: 'faq_q10', faq_a10: 'faq_a10'
    },
    zh: {
      nav_home: "首页",
      nav_about: "关于",
      ...
      home_mission_body:
        "“五行归序传”不仅是一场营会，更是一次穿越千年的心灵对话。我们致力于通过五行哲学（金、木、水、火、土）的深度沉浸，让每一位参与者在快节奏的现代生活中，重新触摸中华文化的温度与智慧。",
      about_history_title: "南大中文学会简介",
      about_history_body:
        "南洋理工大学中文学会自成立以来，始终致力于搭建连接传统与现代的桥梁。我们是一群热爱汉文化的青年，旨在通过创新的形式，将沉睡的经典转化为鲜活的体验。",
      fee_title: "报名费用",
      fee_full: "全程参与 (含住宿)",
      fee_day: "日间通行 (不含住宿)",
      ...
      // Event details (registration & about pages)
      event_date: '2026年6月5日–6月7日',
      event_venue: '南洋理工大学校区',
      event_fee_full: '$95（含住宿）',
      event_fee_day: '$15（不含住宿）',
      event_fee_full_amount: '$95',
      event_fee_day_amount: '$15',
      reg_event_title: '第十一届全国青年华人文化研习与生活营',
      reg_date_label: '日期：',
      reg_venue_label: '地点：',
      reg_fee_label: '报名费：',
      reg_objectives_label: '活动宗旨：',
      reg_objectives_value: '提升青少年对华人传统文化的认识，鼓励从新颖角度探索与发掘华人文化',
      faq_q1: "谁可以参加？",
