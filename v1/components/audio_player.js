export class AudioPlayer {
    constructor() {
        ...
        // Use the project's local background music file (place it under v1/assets/audio/background_music.mp3)
    ...
    render() {
        this.container.innerHTML = `
            <div class="flex flex-col items-end gap-2">
                ...
                <button id="music-toggle" class="p-4 bg-midnight-blue text-gold rounded-full shadow-2xl hover:scale-110 transition-transform ${this.isPlayingMusic ? 'audio-playing' : ''}">
